...
\begin{center}
\begin{equation}
P=R*i_{0}^2=\frac{R*I^2}{2}(1+cos(2\omega t))=P_{ac}+P_{dc}
\end{equation}
\end{center}
...
\end{equation}
On designe par $\lvert \Delta T_{ac} \rvert$ l'amplitude de la température alternative.
...
\captionof{figure}{Schema décrivant la géométrie des échantillons utilisés pour la méthode 3w}
\label{fig4} 
\end{center}
...
\captionof{figure}{système subatstrat et couches minces}
\end{center}
